      ...
      <div className="register-form-container">
        ...
        <form className="register-form" onSubmit={handleSubmit} noValidate>
          ...
          <input
            ...
            required
          />
          {errors.fullName && submitted && <div className="error-message">{errors.fullName}</div>}
          ...
          <input
            ...
            required
          />
          {errors.email && submitted && <div className="error-message">{errors.email}</div>}
          ...
          <input
            ...
            required
          />
          {errors.username && submitted && <div className="error-message">{errors.username}</div>}
          ...
          <div className="register-form-row">
            <div className="password-input-wrapper">
              ...
              {errors.password && submitted && <div className="error-message">{errors.password}</div>}
            </div>
